...
export default {
  ...
  setup() {
    ...
    const addNewIngredient = () => {
      newRecipe.value.ingrediantRows++
    }
      ...
      <div class="popup-content">
        ...
        <form @submit.prevent="addNewRecipe">
          ...
          <div class="group">
            ...
            <div class="ingrediant" v-for="i in newRecipe.ingrediantRows" :key="i">
              <input type="text" v-model="newRecipe.ingrediants[i-1]"/>
            </div>
             <button type="button" @click="addNewIngredient">Add Ingrediant</button>
